...
tk.Button(root, text="hello world", command=show_tet).grid(row=0,column=0)

tk.Button(root, text="weather(fryser programmet litt)", command=run_weather).grid(row=4,column= 4)
